...
const Appointment = () => {
    ...
    const bookAppointment = async () => {
        ...
        // ✅ Get user info INSIDE the booking function!
        const userId = localStorage.getItem('userId');
        const userData = {
          name: localStorage.getItem('name'),
          email: localStorage.getItem('email')
        };
        console.log("Booking appointment with:", { docId, slotDate, slotTime, userId, userData });
    
        try {
            const { data } = await axios.post(
                backendUrl + '/api/user/book-appointment',
                { docId, slotDate, slotTime, userId, userData },
                { headers: { token } }
            );
            if (data.success) {
